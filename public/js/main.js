  ...
  render: function(){
    return (
      React.createElement("div", {className: "row"}, 
        ...
        React.createElement("div", {className: "col-xs-4"}, 
          React.createElement(RedditThing, null)
        )
      )
    )
  }
...
},{"./RedditThing":2,"./TimeDisplay":3,"./Timer":4,"react":161}],2:[function(require,module,exports){
var React = require('react');
  ...
  render: function(){
    ...
    var posts = this.state.posts.map(function(post, idx){
      return (
        React.createElement("tr", {key: idx}, 
          React.createElement("td", null, post.data.score), 
          React.createElement("td", null, post.data.title)
        )
      );
    });
    ...
    return (
      React.createElement("div", null, 
        React.createElement("button", {onClick: this.getPosts}, "Load posts"), 
        React.createElement("table", {className: "table"}, posts)
      )
    )
  }
});
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function(){
    var laps = this.state.laps.map(function(item, idx){
      return (
        React.createElement("div", {key: idx}, 
          "Lap ", idx + 1, ": ", React.createElement(TimeDisplay, {time: item})
        )
      );
    });
    ...
    return (
      React.createElement("div", null, 
        React.createElement(TimeDisplay, {time: this.state.time}), 
...
},{"./TimeDisplay":3,"react":161}],5:[function(require,module,exports){
var React = require('react');
var MyApp = require('./components/MyApp');

React.render(React.createElement(MyApp, null), document.getElementById('container'));

},{"./components/MyApp":1,"react":161}],6:[function(require,module,exports){
